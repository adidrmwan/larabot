...
<body data-bg-img="assets/img/bg/page-bg.jpg">
    ...
    <header class="header">
     ...
     <!-- Feeds -->
     <section class="pt-120 pb-90" style="margin-top:50px;">
        <div class="container">
            <div class="grid row justify-content-center">
                <div class="col-xl-4 col-lg-4 col-md-6 element-item artwork memes">
                    <div class="single-product style--three">
                        <div class="product-content">
                            <div class="product-top">
                                <h3 style="padding-bottom: 15px;">Basic Plan - Starter</h3>
                                <div style="padding-bottom: 15px;">
                                  <h5> Features : </h5>
                                  <p>
                                  • Access to core storytelling and narrative generation tools.
                                    <br>
                                  • Build and train up to 2 custom AI agents.
                                   <br>
                                  • 10 hours/month of compute for training models.
                                  </p>
                                  <br>
                                  <br>
                                  <br>
                                ...
                                <div class="d-flex justify-content-between">
                                    <h6 class="c1">PRICE : COMING SOON</h6>
                                </div>
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 element-item artwork memes">
                    <div class="single-product style--three">
                        <div class="product-content">
                            <div class="product-top">
                                <h3 style="padding-bottom: 15px;">Pro Plan - Advanced </h3>
                                <div style="padding-bottom: 15px;">
                                  <h5> Features : </h5>
                                  <p>
                                  • Unlimited story generation and advanced narrative customization.
                                    <br>
                                  • Train up to 10 custom AI agents with advanced configurations.
                                   <br>
                                  • 50 hours/month of compute for extensive training needs.
                                  <br>
                                  • Access to exclusive technical training modules and datasets.
                                  </p>
                                  <br>
                                  <br>
                                  <br>
                            ...
                            <div class="product-top">
                                ...
                                <div style="padding-bottom: 15px;">
                                  ...
                                  • Unlimited AI agent creation with full customization.
                                    <br>
                                  • Dedicated compute resources for large-scale training.
                                   <br>
                                  • API access for seamless integration into enterprise workflows.
                                  <br>
                                  • Customizable pipelines for specific business or research applications.
                                  </p>
                                  <br>
                                  <br>
                                </div>
